...
[Whitepaper](https://github.com/imusify/imusify.github.io/blob/master/new.html)
...
1) transfer speed, and 
2) file size of the transactions. We cannot influence the former, although we know it will get higher over time, but we can influence the file size.
